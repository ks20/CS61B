...
class Move {
    ...
    static Move move(char col0, char row0, char col1, char row1) {
        ...
        char r1 = row1;
        return
            ALL_MOVES[c0 - 'a' + 2][r0 - '1' + 2][c1 - 'a' + 2][r1 - '1' + 2];
    }
    ...
    boolean isExtend() {
        if (col1() == col0() + 1 && row1() == row0()) {
            return true;
        } else if (col1() == col0() - 1 && row1() == row0()) {
            return true;
        } else if (row1() == row0() + 1 && col1() == col0()) {
            return true;
        } else if (row1() == row0() - 1 && col1() == col0()) {
            return true;
        } else if (row1() == row0() + 1 && col1() == col0() + 1) {
            return true;
        } else if (row1() == row0() - 1 && col1() == col0() + 1) {
            return true;
        } else if (row1() == row0() - 1 && col1() == col0() - 1) {
