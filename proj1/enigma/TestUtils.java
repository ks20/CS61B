...
class TestUtils {
    ...
    static {
        ...
        NAVALA_MAP.put("B", "ENKQAUYWJICOPBLMDXZVFTHRGS");
    ...
    static final HashMap<String, String> NAVALC_MAP = new HashMap<>();
    static {
        NAVALC_MAP.put("I", "KDJEBOTXLRMUWFVSQNYGZPAHCI");
        NAVALC_MAP.put("II", "ICJRHQTWAKGVSLBPFYMOXEUNDZ");
        NAVALC_MAP.put("III", "CEGIKBOQSWUYMXDHVFZJLTRPNA");
        NAVALC_MAP.put("IV", "RNUOYIZXPTHQGWKMESFJCBLVAD");
        NAVALC_MAP.put("V", "YAQFHSXTORCMGKWZVLIPNEDBJU");
        NAVALC_MAP.put("VI", "OFUNTLEXPADMGYQCJZRWKHBSVI");
        NAVALC_MAP.put("VII", "YIGFQBWLXRVANTEZHUKODJPCSM");
        NAVALC_MAP.put("VIII", "JPGSKWNBAIROCYQZLDVMHTXFUE");
        NAVALC_MAP.put("Beta", "DXIUBMHWVOAPLCQSZJYFETGNRK");
        NAVALC_MAP.put("Gamma", "RNJZMTDQGLASHXBVKPOYWUFICE");
    }
